...
def evaluate(
    ...
    if server_round == 3:
        with open('/home/jhmoon/venvFL/2023-paper-Federated_Learning/multiFL/sensIT/weights/acoustic_weights3.pickle', 'wb') as f:
            pickle.dump(parameters, f)
    elif server_round == 2:
        with open('/home/jhmoon/venvFL/2023-paper-Federated_Learning/multiFL/sensIT/weights/acoustic_weights2.pickle', 'wb') as f:
            pickle.dump(parameters, f)
    else:
        with open('/home/jhmoon/venvFL/2023-paper-Federated_Learning/multiFL/sensIT/weights/acoustic_weights1.pickle', 'wb') as f:
            pickle.dump(parameters, f)
